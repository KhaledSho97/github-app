package com.khaledsh.core.base
 ...
 * @see Fragment
 */
abstract class BaseFragment<B : ViewDataBinding, M : ViewModel>() : Fragment(), HasAndroidInjector {
    ...
    override fun onCreateView(
        ...
        _viewBinding = DataBindingUtil.inflate(inflater, getLayoutId(), container, false)
